...
########################################
#for i in xrange(len(n_poss0)):
#    print "poss0[{0}] = {1} {2}".format(i, n_poss0[i], l_poss0[i])
#for i in xrange(len(n_poss1)):
#    print "poss1[{0}] = {1} {2}".format(i, n_poss1[i], l_poss1[i])
#for i in xrange(len(n_poss1)):
#    print "poss2[{0}] = {1} {2}".format(i, n_poss2[i], l_poss2[i])
#for i in xrange(len(n_poss2)):
#    print "poss3[{0}] = {1} {2}".format(i, n_poss3[i], l_poss3[i])
