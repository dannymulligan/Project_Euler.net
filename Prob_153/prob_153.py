...
#
# A Gaussian integer is called a divisor of a rational integer n if
# the result is also a Gaussian integer.
#
...
#    1+2i which is 1−2i.
#
#    The result is 5 / (1 + 2i) = (5 * (1 - 2i)) / ((1 + 2i) * (1 - 2i))
#        = (5 * (1 - 2i)) / 5 = 1 - 2i
#
#    So 1+2i is a divisor of 5.
#
#    Note that 1+i is not a divisor of 5 because 5/(1+i) = (5 *
#    (1-i))/((1+i)*(1-i)) = (5*(1-i)) / 2 = (5/2) - (i/2)
#
...
#    divisor of n.
#
# In fact, 5 has six divisors such that the real part is positive: {1,
# 1 + 2i, 1 − 2i, 2 + i, 2 − i, 5}.
#
