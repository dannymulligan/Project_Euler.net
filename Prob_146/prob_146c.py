...
# This program is able to search to 25 million in 63 seconds. This is
# about 1.1x faster than the previous version.  I need to make it
# about 6x faster.
#
...
#for n in xrange(10,25000000,10):
for n in xrange(10,150000000,10):
    ...
    if (((n % 3) == 0) | ((n % 7) == 0) | ((n % 9) == 0) | ((n % 13) == 0) | ((n % 27) == 0)):
        continue
        # if n is a multiple of 3, then n^2 will be a multiple of 3, and n^2+3 will be a multiple of 3 and not prime
        # if n is a multiple of 7, then n^2 will be a multiple of 7, and n^2+7 will be a multiple of 7 and not prime
        # similar argument for 7, 9, 13, and 27
...
# Time taken to calculate primes = 145.384186 seconds
